...
public class PaginarResultados implements PaginarResultado {
    @Override
    public Page<FornecedorResponseDTO> paginarResultados(List<FornecedorResponseDTO> fornecedores, Pageable pageable) {
        ...
        List<FornecedorResponseDTO> fornecedoresPaginados = fornecedores.subList(start, end); // Sublista da página atual
